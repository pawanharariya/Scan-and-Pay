...
public class ScanningActivity extends AppCompatActivity {
    ...
    private void processScanResult() {
        ...
        Toast.makeText(getApplicationContext(), scanResultString, Toast.LENGTH_LONG).show();
        db.collection(Constants.STORES_BASE_URL)
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        Toast.makeText(getApplicationContext(),"Document " +
                                "does not exist" + scanResultString, Toast.LENGTH_LONG).show();
                        showInfoDialog();
                    }
                })
                .addOnFailureListener(e -> {
